      ...
      '/headless-cms/': [
        {
          ...
          items: [
            ...
            { text: 'API keys & security', link: '/headless-cms/api-keys' },
            { text: 'Query DSL reference', link: '/headless-cms/query-dsl' },
            { text: 'Webhooks & exports', link: '/headless-cms/webhooks-and-exports' },
            { text: 'Troubleshooting', link: '/headless-cms/troubleshooting' },
          ],
        },
      ],
      '/domains/': [
